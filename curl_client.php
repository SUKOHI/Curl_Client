...
class Curl_Client {
    ...
    public function addCookie($cookie_content) {
        ...
        $this->_cookies[$domain_var_name][$path_var_name][$cookie_name] = array(
    ...
    public function removeCookie($domain, $path, $cookie_name) {
        
        $domain_var_name = '[D]:'. $domain;
        $path_var_name = '[P]:'. $path;
        unset($this->_cookies[$domain_var_name][$path_var_name][$cookie_name]);
...
[Add Cookie]
    ...
    $client->addCookie('key=value;domain=example.com;path=/;');
